    ...
    <div class="main-content">
      ...
      <el-menu class="el-menu-vertical" default-active="1" router background-color="#ffffff" text-color="#000000"
        ...
        <template v-if="isHomePage">
          <el-menu-item index="1" :class="{ 'active-item': activeIndex === '1' }">拓扑概览</el-menu-item>
          <el-menu-item index="2" :class="{ 'active-item': activeIndex === '2' }">实验状态</el-menu-item>
          <el-menu-item index="3" :class="{ 'active-item': activeIndex === '3' }">系统状态</el-menu-item>
        </template>
